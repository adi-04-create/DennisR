/* This is the CENTRAL FILE for all the functions being used in all the function files for CHAPTER-2
...
uint32_t main()
{
	...
	/* the function which we want to execute, simultaniously we uncomment the function   */
	...
	/* func_2_10.c*/
	/* Convert upper case to lower case without if - else  */
	   upper2lower();
	return 0;
}
/* end of main program */
